...
module.exports = {
    ...
    onedrive: {
        callbackURL: process.env.ONEDRIVE_CALLBACK_URL || 'http://localhost:3000/api/onedrive/callback/oauth',
        credentials: {
            client_id: process.env.ONEDRIVE_CLIENT_ID || '<replace with your egnyte client id',
            client_secret: process.env.ONEDRIVE_CLIENT_SECRET || '<replace with your egnyte client secret'
        }
    }
};