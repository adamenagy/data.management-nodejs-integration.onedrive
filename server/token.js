...
// Onedrive token handling

Token.prototype.getOnedriveToken = function () {
  return this._session.onedriveToken 
} 

Token.prototype.setOnedriveToken = function (token) {
  this._session.onedriveToken = token 
} 

Token.prototype.getOnedriveClient = function () {
  return this._session.onedriveClient 
} 

Token.prototype.setOnedriveClient = function (client) {
  this._session.onedriveClient = client 
} 

Token.prototype.isOnedriveAuthorized = function () {
  return (this._session != null && this._session.onedriveToken != null) 
} 
